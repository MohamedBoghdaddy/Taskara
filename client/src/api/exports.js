...
export const exportTasks = (params = {}) =>
  downloadCSV(`/exports/tasks?${new URLSearchParams(params)}`, "tasks.csv");
export const exportAnalytics = (days = 30) =>
  downloadCSV(`/exports/analytics?days=${days}`, "analytics.csv");
