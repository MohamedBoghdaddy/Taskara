...
import {
  faHome, faTasks, faCalendarAlt, faBell, faSearch, faCog, faUser,
  faPlus, faEdit, faTrashAlt, faCheck, faTimes, faChevronLeft,
  faChevronRight, faChevronDown, faChevronUp, faBars, faMoon, faSun,
  faSignOutAlt, faEllipsisH, faEllipsisV, faEye, faEyeSlash,
  faLock, faStar, faHeart, faFire, faRocket, faBolt,
  faBrain, faLightbulb, faComment, faComments, faTag, faTags,
  faFolder, faFolderOpen, faFile, faFileAlt, faFilePdf, faFileCode,
  faImage, faVideo, faMusic, faMicrophone, faPaperclip, faLink,
  faExternalLinkAlt, faCopy, faUndo, faRedo, faBold, faItalic,
  faUnderline, faStrikethrough, faListUl, faListOl, faQuoteLeft,
  faCode, faTable, faColumns, faAlignLeft, faAlignCenter, faAlignRight,
  faSave, faDownload, faUpload, faShare, faShareAlt,
  faFilter, faSort, faExpand, faCompress, faArrowLeft, faArrowRight,
  ...
  faUsers, faUserPlus, faUserCheck, faUserCog, faCrown, faShield,
  faChartBar, faChartLine, faChartPie, faChartArea,
  faProjectDiagram, faSitemap, faCodeBranch,
  faInbox, faEnvelope, faPaperPlane, faHashtag, faAt,
  faLayerGroup, faObjectGroup, faDrawPolygon, faMagic, faRobot,
  faPalette, faGlobe, faWifi, faCloud, faCloudUploadAlt, faCloudDownloadAlt,
  faDatabase, faServer,
  ...
  faHeading, faStickyNote, faBookmark, faBook, faBookOpen,
  faTrophy, faMedal, faRunning, faCoffee, faMapPin, faFlag,
  faKey, faToggleOn, faToggleOff, faSlidersH,
  faThumbsUp, faSmile, faStream, faNetworkWired, faTachometerAlt,
  faCubes, faCube, faBox, faBoxOpen,
  faClipboardList, faClipboardCheck, faClipboard,
  faObjectUngroup, faWindowMaximize, faTerminal, faExchangeAlt,
  faLevelDownAlt, faDotCircle, faCheckSquare,
  faRoad, faRoute, faMapMarkerAlt,
  faBellSlash, faUserMinus, faShieldAlt,
  faPercent, faCalculator, faBarcode, faPrint,
  faEnvelopeOpen, faUserShield,
  faChartArea as faArea,
  faEject, faFastForward, faStepForward,
  faHourglass, faHourglassHalf,
  faBolt as faFlash,
  faWindowMinimize, faWindowRestore,
  faDotCircle as faDot,
  faWaveSquare,
  faEquals, faMinus,
  faRecycle,
  faEllipsisV as faMenuV,
  faListAlt,
  faSortUp, faSortDown,
  faSignal,
  faBroadcastTower,
  ...
  faExpandAlt,
  faCommentAlt,
  faEllipsisV as faDots,
  faCaretDown,
  faCaretUp,
  faCaretLeft,
  faCaretRight,
  faInfoCircle as faHelpCircle,
  faShieldAlt as faPrivacy,
  faUserLock,
  faHandshake,
  faLightbulb as faIdea,
  faBalanceScale,
  faBellSlash as faMuted,
  faHdd,
  faMemory,
  faDesktop,
  faMobile,
