...
beforeEach(() => {
  ...
  getAllPlans.mockResolvedValue({
    plans: [
      { key: 'free', name: 'Workflow Free', billingPeriod: 'month', workflowLimit: 15, actionLimit: 60, integrationLimit: 1, autoExecution: false, manualApprovalsRequired: true },
      { key: 'pro', name: 'Workflow Pro', billingPeriod: 'month', workflowLimit: 250, actionLimit: 1200, integrationLimit: 3, autoExecution: true, manualApprovalsRequired: false },
      { key: 'team', name: 'Workflow Team', billingPeriod: 'month', workflowLimit: 1500, actionLimit: 8000, integrationLimit: 8, autoExecution: true, manualApprovalsRequired: false },
      { key: 'enterprise', name: 'Workflow Enterprise', billingPeriod: 'month', workflowLimit: -1, actionLimit: -1, integrationLimit: -1, autoExecution: true, manualApprovalsRequired: false, priceLabel: 'Custom' },
    ],
  });
  getCurrentPlan.mockResolvedValue({
    effectivePlan: 'pro',
    planDef: { name: 'Workflow Pro', autoExecution: true, manualApprovalsRequired: false },
    usage: {
